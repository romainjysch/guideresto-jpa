...
import ch.hearc.ig.guideresto.business.IAmRestaurant;
...
public class CLI {
  ...
  private void searchRestaurantByName() {
    ...
    Set<Restaurant> restaurants = restaurantService.researchRestaurantsByName(research);
  ...
  private void searchRestaurantByCity() {
    ...
    Set<Restaurant> restaurants = restaurantService.researchRestaurantsByCityName(research);
  ...
  private void searchRestaurantByType() {
    ...
    Set<Restaurant> restaurants = restaurantService.researchRestaurantsByType(chosenType);
  ...
  private void editRestaurant(Restaurant restaurant) {
    ...
    if (newType != restaurant.getType()) {
      restaurant.getType().getRestaurants().remove(
